...
public class PayTRController : Controller
{
    ...
    [HttpPost]
    public IActionResult Paytr(int tutar, string mail, string ad, string tel, string aciklama)
    {
        ...
        string merchant_id = "295060";
        string merchant_key = "FZsmRJ6kNUyAUny4";
        string merchant_salt = "radcAdje4DE26PHr";
        //
        ...
        string user_ip = "212.154.101.239";
    ...
    [HttpPost]
    public IActionResult Bildirim(object a)
    {
