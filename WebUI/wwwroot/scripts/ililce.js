const selectedProvince = document.currentScript.getAttribute('province');
const selectedDistrict = document.currentScript.getAttribute('district');
...
$(document).ready(function () {
    $.each(data, function (index, value) {
        let selectedElement = selectedProvince == value.plaka;
        if (!selectedElement) {
            $('#Iller').append($('<option>', {
                value: value.plaka,
                text: value.il,
    ...
    if (selectedProvince != null) {
        ...
        $.each(resultObject.ilceleri, function (index, value) {
            let selectedElement = selectedDistrict == value.plaka;
